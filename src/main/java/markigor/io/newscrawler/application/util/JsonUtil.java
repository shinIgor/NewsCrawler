...
public class JsonUtil<T> {
    ...
    public void initialize() {
        ...
        javaTimeModule.addSerializer(LocalDate.class,
                new LocalDateSerializer(DateTimeFormatter.ofPattern(FormatDefine.DATE)))
            .addSerializer(LocalDateTime.class,
                new LocalDateTimeSerializer(DateTimeFormatter.ofPattern(FormatDefine.DATETIME)))
            .addDeserializer(LocalDate.class,
                new LocalDateDeserializer(DateTimeFormatter.ofPattern(FormatDefine.DATE)))
            .addDeserializer(LocalDateTime.class,
                new LocalDateTimeDeserializer(DateTimeFormatter.ofPattern(FormatDefine.DATETIME)));
        ...
        objectMapper = JsonMapper.builder()
            ...
            .enable(
                MapperFeature.ACCEPT_CASE_INSENSITIVE_ENUMS)                // Enum 대소 문자 구분 하지 않게 지정
            .disable(
                SerializationFeature.WRITE_DATES_AS_TIMESTAMPS)            // JSON에서 날짜를 문자열로 표시하도록 지정
