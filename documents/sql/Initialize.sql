...
(
    ...
    crawler_api_mt_id INT UNSIGNED NOT NULL COMMENT '크롤링 API 호출 사이트 ID',
    ...
    is_scrab          TINY INT NOT NULL COMMENT '수집 여부 (0: 수집 X, 1: 수집 O)',
    updated_at        TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '업데이트 시간',
    created_at        TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '생성 시간'
) ENGINE = INNODB CHARACTER SET utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '뉴스 스크랩 메타테이블';

CREATE INDEX idx_keyword_n2 ON news_crawler.crawler_mt (key_word, crawler_api_mt_id);
...
(
    ...
    created_at    TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '생성 시간'
) ENGINE = INNODB CHARACTER SET utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '뉴스 스크랩 변경 데이터';

CREATE INDEX idx_crawlermtid_n1 ON news_crawler.crawler_lt (crawler_mt_id);

---------------------------------------------------------------------------------------------------------------------------

drop table if exists news_crawler.crawler_api_mt;
create table news_crawler.crawler_api_mt
(
    crawler_api_mt_id INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '크롤링 API 사이트 ID',
    ...
    updated_at        TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '업데이트 시간',
    created_at        TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '생성 시간'
) ENGINE = INNODB CHARACTER SET utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '크롤링 사이트 정보';

CREATE INDEX idx_sitename_n1 ON news_crawler.crawler_api_mt (site_name);
...
(
    crawler_lt_id     INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '크롤링 서비스 로그 ID',
    crawler_api_mt_id INT UNSIGNED NOT NULL COMMENT '크롤링 API 사이트 ID',
    before_data       JSON      NOT NULL COMMENT '변경 전 데이터',
    after_data        JSON      NOT NULL COMMENT '변경 후 데이터',
    created_at        TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '생성 시간'
) ENGINE = INNODB CHARACTER SET utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '뉴스 스크랩 변경 데이터';

CREATE INDEX idx_crawlerapimtid_n1 ON news_crawler.crawler_lt (crawler_api_mt);
...
(
    ...
    cralwer_mt_id      INT UNSIGNED NOT NULL COMMENT '크롤링 ID',
    updated_at         TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '업데이트 시간',
    created_at         TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '생성 시간'
) ENGINE = INNODB CHARACTER SET utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '유저의 뉴스 서비스 테이블';
...
(
    ...
    updated_at        TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '업데이트 시간',
    created_at        TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '생성 시간'
) ENGINE = INNODB CHARACTER SET utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '뉴스 스크랩 데이터';
